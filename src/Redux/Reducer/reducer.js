import {ADD_TODO, FILTER_TODO, MARK_COMPLETED_TODO, MARK_INCOMPLETE_TODO, MARL_ALL_COMPLETED_TODO, REMOVE_TODO, SEARCH_TODO, TOGGLE_TODO} from '../Action/actionType';
const initialState = {
    todos: [],
    filter: 'ALL',
    search: ''
